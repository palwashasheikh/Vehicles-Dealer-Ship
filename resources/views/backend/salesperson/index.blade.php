...
@section('breadcrumb')
    <div class="page-header">
        <h1 class="page-title">Salespeople List</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Salespeople</li>
            </ol>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header justify-content-between">
            <h3 class="card-title font-weight-bold">Salespeople</h3>
            @can('add_salesperson')
                <button type="button" class="btn dark-icon btn-primary" data-act="ajax-modal" data-method="get"
                    ...
                    <i class="ri-add-fill"></i> Add Salesperson
                </button>
            @endcan
        </div>
        <div class="card-body">
...
@push('scripts')
    <script>
     $(function() {
    $('#salesperson_datatable').DataTable({
